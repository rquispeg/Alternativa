...
/**
 * TmpPostulantes form base class.
 *
 * @method TmpPostulantes getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseTmpPostulantesForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tmp_postulantes[%s]');
