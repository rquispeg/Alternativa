...
/**
 * VisClasificadosColectivosTiempo form base class.
 *
 * @method VisClasificadosColectivosTiempo getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseVisClasificadosColectivosTiempoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'tiempo'             => new sfValidatorNumber(array('required' => false)),
    ));

    $this->widgetSchema->setNameFormat('vis_clasificados_colectivos_tiempo[%s]');
  ...
  {
    return 'VisClasificadosColectivosTiempo';
  }
