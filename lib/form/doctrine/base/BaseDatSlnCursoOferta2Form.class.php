...
/**
 * DatSlnCursoOferta2 form base class.
 *
 * @method DatSlnCursoOferta2 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseDatSlnCursoOferta2Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_sln_curso_oferta2[%s]');
