...
/**
 * VEstadisticaAlternativa form base class.
 *
 * @method VEstadisticaAlternativa getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseVEstadisticaAlternativaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_estadistica_alternativa[%s]');
  ...
  {
    return 'VEstadisticaAlternativa';
  }
