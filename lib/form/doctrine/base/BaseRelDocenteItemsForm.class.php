...
/**
 * RelDocenteItems form base class.
 *
 * @method RelDocenteItems getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseRelDocenteItemsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('rel_docente_items[%s]');
