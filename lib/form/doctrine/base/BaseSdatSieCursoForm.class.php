...
/**
 * SdatSieCurso form base class.
 *
 * @method SdatSieCurso getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseSdatSieCursoForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'gestion_id'             => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SdatSlnCursoOferta_4'), 'add_empty' => false)),
      'operativo_id'           => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('SdatSlnCursoOferta_3'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'gestion_id'             => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('SdatSlnCursoOferta_4'))),
      'operativo_id'           => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('SdatSlnCursoOferta_3'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('sdat_sie_curso[%s]');
