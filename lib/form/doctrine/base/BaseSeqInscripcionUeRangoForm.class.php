...
/**
 * SeqInscripcionUeRango form base class.
 *
 * @method SeqInscripcionUeRango getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseSeqInscripcionUeRangoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('seq_inscripcion_ue_rango[%s]');
