...
/**
 * DatRdeDatosapoderado form base class.
 *
 * @method DatRdeDatosapoderado getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseDatRdeDatosapoderadoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_rde_datosapoderado[%s]');
