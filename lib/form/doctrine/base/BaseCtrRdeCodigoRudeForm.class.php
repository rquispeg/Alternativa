...
/**
 * CtrRdeCodigoRude form base class.
 *
 * @method CtrRdeCodigoRude getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseCtrRdeCodigoRudeForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_rde_codigo_rude[%s]');
