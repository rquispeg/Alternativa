...
/**
 * CtrRdeDuplicados form base class.
 *
 * @method CtrRdeDuplicados getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseCtrRdeDuplicadosForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_rde_duplicados[%s]');
