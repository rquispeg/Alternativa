...
/**
 * SdatRdeInscripcionTmp form base class.
 *
 * @method SdatRdeInscripcionTmp getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseSdatRdeInscripcionTmpForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'apreciacion_final'          => new sfValidatorString(array('max_length' => 255)),
    ));

    $this->widgetSchema->setNameFormat('sdat_rde_inscripcion_tmp[%s]');
