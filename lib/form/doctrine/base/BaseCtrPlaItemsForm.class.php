...
/**
 * CtrPlaItems form base class.
 *
 * @method CtrPlaItems getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseCtrPlaItemsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_pla_items[%s]');
