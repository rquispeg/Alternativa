...
/**
 * SdatSieAdministrativo form base class.
 *
 * @method SdatSieAdministrativo getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseSdatSieAdministrativoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sdat_sie_administrativo[%s]');
