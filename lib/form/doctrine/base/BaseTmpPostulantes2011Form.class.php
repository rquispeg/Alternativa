...
/**
 * TmpPostulantes2011 form base class.
 *
 * @method TmpPostulantes2011 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseTmpPostulantes2011Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tmp_postulantes2011[%s]');
