...
/**
 * VUeBachilleres2011 form base class.
 *
 * @method VUeBachilleres2011 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseVUeBachilleres2011Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_ue_bachilleres2011[%s]');
