...
/**
 * AuxDplLegalizacion form base class.
 *
 * @method AuxDplLegalizacion getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseAuxDplLegalizacionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'observacion'        => new sfValidatorString(array('max_length' => 50, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('aux_dpl_legalizacion[%s]');
