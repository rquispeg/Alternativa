...
/**
 * DatSieAdministrativo form base class.
 *
 * @method DatSieAdministrativo getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseDatSieAdministrativoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_sie_administrativo[%s]');
