...
/**
 * SdatRdeSocioEconomico form base class.
 *
 * @method SdatRdeSocioEconomico getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseSdatRdeSocioEconomicoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sdat_rde_socio_economico[%s]');
