...
/**
 * VCee2011 form base class.
 *
 * @method VCee2011 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseVCee2011Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_cee2011[%s]');
