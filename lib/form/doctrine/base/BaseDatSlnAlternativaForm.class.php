...
/**
 * DatSlnAlternativa form base class.
 *
 * @method DatSlnAlternativa getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseDatSlnAlternativaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_sln_alternativa[%s]');
