...
/**
 * CtrSlnFormal2 form base class.
 *
 * @method CtrSlnFormal2 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseCtrSlnFormal2Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_sln_formal2[%s]');
