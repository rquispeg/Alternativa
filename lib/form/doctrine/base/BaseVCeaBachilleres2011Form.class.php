...
/**
 * VCeaBachilleres2011 form base class.
 *
 * @method VCeaBachilleres2011 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseVCeaBachilleres2011Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_cea_bachilleres2011[%s]');
