...
/**
 * ViewUeCantidad form base class.
 *
 * @method ViewUeCantidad getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseViewUeCantidadForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('view_ue_cantidad[%s]');
