...
/**
 * ReporteAlternativa form base class.
 *
 * @method ReporteAlternativa getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseReporteAlternativaForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reporte_alternativa[%s]');
