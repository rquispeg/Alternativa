...
/**
 * VUnidadEducativasCertificadasBachilleres form base class.
 *
 * @method VUnidadEducativasCertificadasBachilleres getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseVUnidadEducativasCertificadasBachilleresForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_unidad_educativas_certificadas_bachilleres[%s]');
  ...
  {
    return 'VUnidadEducativasCertificadasBachilleres';
  }
