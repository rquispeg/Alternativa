...
/**
 * CeaEstudiantesPrimer form base class.
 *
 * @method CeaEstudiantesPrimer getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseCeaEstudiantesPrimerForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cea_estudiantes_primer[%s]');
