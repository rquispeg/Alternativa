...
/**
 * VInscripcion2007 form base class.
 *
 * @method VInscripcion2007 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseVInscripcion2007Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_inscripcion2007[%s]');
