...
/**
 * ReporteAlternativa2010 form base class.
 *
 * @method ReporteAlternativa2010 getObject() Returns the current form's model object
 *
 * @package    alternativa
 * @subpackage form
 ...
 */
abstract class BaseReporteAlternativa2010Form extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reporte_alternativa2010[%s]');
