...
Doctrine_Manager::getInstance()->bindComponent('TmpPostulantes2011', 'doctrine');

/**
 * BaseTmpPostulantes2011
 * 
 ...
 * @method TmpPostulantes2011 setId()                 Sets the current record's "id" value
 * @method TmpPostulantes2011 setGestionId()          Sets the current record's "gestion_id" value
 * @method TmpPostulantes2011 setDescDepartamento()   Sets the current record's "desc_departamento" value
 * @method TmpPostulantes2011 setCodDistrito()        Sets the current record's "cod_distrito" value
 * @method TmpPostulantes2011 setDistrito()           Sets the current record's "distrito" value
 * @method TmpPostulantes2011 setCodUe()              Sets the current record's "cod_ue" value
 * @method TmpPostulantes2011 setDescUe()             Sets the current record's "desc_ue" value
 * @method TmpPostulantes2011 setCalculatedColumn1()  Sets the current record's "calculated_column1" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseTmpPostulantes2011 extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('tmp_postulantes_2011');
