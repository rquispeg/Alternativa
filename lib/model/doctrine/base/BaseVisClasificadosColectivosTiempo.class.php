...
Doctrine_Manager::getInstance()->bindComponent('VisClasificadosColectivosTiempo', 'doctrine');

/**
 * BaseVisClasificadosColectivosTiempo
 * 
 ...
 * @method decimal                         getTiempo()             Returns the current record's "tiempo" value
 * @method VisClasificadosColectivosTiempo setId()                 Sets the current record's "id" value
 * @method VisClasificadosColectivosTiempo setCodUe()              Sets the current record's "cod_ue" value
 * @method VisClasificadosColectivosTiempo setDescUe()             Sets the current record's "desc_ue" value
 * @method VisClasificadosColectivosTiempo setPosicion()           Sets the current record's "posicion" value
 * @method VisClasificadosColectivosTiempo setGeneroId()           Sets the current record's "genero_id" value
 * @method VisClasificadosColectivosTiempo setDescDisciplina()     Sets the current record's "desc_disciplina" value
 * @method VisClasificadosColectivosTiempo setDescPrueba()         Sets the current record's "desc_prueba" value
 * @method VisClasificadosColectivosTiempo setCircunscripcionId()  Sets the current record's "circunscripcion_id" value
 * @method VisClasificadosColectivosTiempo setTipoId()             Sets the current record's "tipo_id" value
 * @method VisClasificadosColectivosTiempo setCodDistrito()        Sets the current record's "cod_distrito" value
 * @method VisClasificadosColectivosTiempo setDistrito()           Sets the current record's "distrito" value
 * @method VisClasificadosColectivosTiempo setCodigoRude()         Sets the current record's "codigo_rude" value
 * @method VisClasificadosColectivosTiempo setCarnetIdentidad()    Sets the current record's "carnet_identidad" value
 * @method VisClasificadosColectivosTiempo setPaterno()            Sets the current record's "paterno" value
 * @method VisClasificadosColectivosTiempo setMaterno()            Sets the current record's "materno" value
 * @method VisClasificadosColectivosTiempo setNombre()             Sets the current record's "nombre" value
 * @method VisClasificadosColectivosTiempo setFechaNacimiento()    Sets the current record's "fecha_nacimiento" value
 * @method VisClasificadosColectivosTiempo setTiempo()             Sets the current record's "tiempo" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseVisClasificadosColectivosTiempo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vis_clasificados_colectivos_tiempo');
        ...
        $this->hasColumn('tiempo', 'decimal', 17, array(
             'type' => 'decimal',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
