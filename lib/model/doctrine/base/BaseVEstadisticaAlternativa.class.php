...
Doctrine_Manager::getInstance()->bindComponent('VEstadisticaAlternativa', 'doctrine');

/**
 * BaseVEstadisticaAlternativa
 * 
 ...
 * @method VEstadisticaAlternativa setId()                 Sets the current record's "id" value
 * @method VEstadisticaAlternativa setTipo()               Sets the current record's "tipo" value
 * @method VEstadisticaAlternativa setGestionId()          Sets the current record's "gestion_id" value
 * @method VEstadisticaAlternativa setDescDepartamento()   Sets the current record's "desc_departamento" value
 * @method VEstadisticaAlternativa setCodDistrito()        Sets the current record's "cod_distrito" value
 * @method VEstadisticaAlternativa setDistrito()           Sets the current record's "distrito" value
 * @method VEstadisticaAlternativa setCodUe()              Sets the current record's "cod_ue" value
 * @method VEstadisticaAlternativa setDescUe()             Sets the current record's "desc_ue" value
 * @method VEstadisticaAlternativa setCalculatedColumn1()  Sets the current record's "calculated_column1" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseVEstadisticaAlternativa extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('v_estadistica_alternativa');
