...
Doctrine_Manager::getInstance()->bindComponent('VInscripcion2009', 'doctrine');

/**
 * BaseVInscripcion2009
 * 
 ...
 * @method VInscripcion2009 setId()                         Sets the current record's "id" value
 * @method VInscripcion2009 setIdInscripcion()              Sets the current record's "id_inscripcion" value
 * @method VInscripcion2009 setGestionId()                  Sets the current record's "gestion_id" value
 * @method VInscripcion2009 setCodigoRudeId()               Sets the current record's "codigo_rude_id" value
 * @method VInscripcion2009 setNumMatricula()               Sets the current record's "num_matricula" value
 * @method VInscripcion2009 setCodUeId()                    Sets the current record's "cod_ue_id" value
 * @method VInscripcion2009 setPeriodoId()                  Sets the current record's "periodo_id" value
 * @method VInscripcion2009 setOperativoId()                Sets the current record's "operativo_id" value
 * @method VInscripcion2009 setSubCeaId()                   Sets the current record's "sub_cea_id" value
 * @method VInscripcion2009 setNivelId()                    Sets the current record's "nivel_id" value
 * @method VInscripcion2009 setGradoId()                    Sets the current record's "grado_id" value
 * @method VInscripcion2009 setCicloId()                    Sets the current record's "ciclo_id" value
 * @method VInscripcion2009 setParalelo()                   Sets the current record's "paralelo" value
 * @method VInscripcion2009 setTurnoId()                    Sets the current record's "turno_id" value
 * @method VInscripcion2009 setEstadoMatriculaInicioId()    Sets the current record's "estado_matricula_inicio_id" value
 * @method VInscripcion2009 setEstadoMatriculaFinId()       Sets the current record's "estado_matricula_fin_id" value
 * @method VInscripcion2009 setCodUeProcedenciaId()         Sets the current record's "cod_ue_procedencia_id" value
 * @method VInscripcion2009 setObservacionId()              Sets the current record's "observacion_id" value
 * @method VInscripcion2009 setObservacion()                Sets the current record's "observacion" value
 * @method VInscripcion2009 setFechaInscripcion()           Sets the current record's "fecha_inscripcion" value
 * @method VInscripcion2009 setApreciacionFinal()           Sets the current record's "apreciacion_final" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseVInscripcion2009 extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('v_inscripcion_2009');
