...
Doctrine_Manager::getInstance()->bindComponent('CtrSlnFormal', 'doctrine');
 ...
 * @method CtrSlnFormal      setGestionId()                   Sets the current record's "gestion_id" value
 * @method CtrSlnFormal      setCodUeId()                     Sets the current record's "cod_ue_id" value
 * @method CtrSlnFormal      setCursoOfertaId()               Sets the current record's "curso_oferta_id" value
 * @method CtrSlnFormal      setInscripcionId()               Sets the current record's "inscripcion_id" value
 * @method CtrSlnFormal      setPrimerTrimestre()             Sets the current record's "primer_trimestre" value
 * @method CtrSlnFormal      setSegundoTrimestre()            Sets the current record's "segundo_trimestre" value
 * @method CtrSlnFormal      setTercerTrimestre()             Sets the current record's "tercer_trimestre" value
 * @method CtrSlnFormal      setPromedioAnual()               Sets the current record's "promedio_anual" value
 * @method CtrSlnFormal      setReforzamiento()               Sets the current record's "reforzamiento" value
 * @method CtrSlnFormal      setPromedioFinal()               Sets the current record's "promedio_final" value
 * @method CtrSlnFormal      setPrimerEval()                  Sets the current record's "primer_eval" value
 * @method CtrSlnFormal      setSegundoEval()                 Sets the current record's "segundo_eval" value
 * @method CtrSlnFormal      setTercerEval()                  Sets the current record's "tercer_eval" value
 * @method CtrSlnFormal      setPrimerDiasTrab()              Sets the current record's "primer_dias_trab" value
 * @method CtrSlnFormal      setSegundoDiasTrab()             Sets the current record's "segundo_dias_trab" value
 * @method CtrSlnFormal      setTercerDiasTrab()              Sets the current record's "tercer_dias_trab" value
 * @method CtrSlnFormal      setReforzamientoDiasTrab()       Sets the current record's "reforzamiento_dias_trab" value
 * @method CtrSlnFormal      setPrimerFaltasLicencia()        Sets the current record's "primer_faltas_licencia" value
 * @method CtrSlnFormal      setSegundoFaltasLicencia()       Sets the current record's "segundo_faltas_licencia" value
 * @method CtrSlnFormal      setTecerFaltasLicencia()         Sets the current record's "tecer_faltas_licencia" value
 * @method CtrSlnFormal      setPrimerFaltasSinLicencia()     Sets the current record's "primer_faltas_sin_licencia" value
 * @method CtrSlnFormal      setSegundoFaltasSinLicencia()    Sets the current record's "segundo_faltas_sin_licencia" value
 * @method CtrSlnFormal      setTercerFaltasSinLicencia()     Sets the current record's "tercer_faltas_sin_licencia" value
 * @method CtrSlnFormal      setFechaActualizacion()          Sets the current record's "fecha_actualizacion" value
 * @method CtrSlnFormal      setUsuarioId()                   Sets the current record's "usuario_id" value
 * @method CtrSlnFormal      setFechaCambio()                 Sets the current record's "fecha_cambio" value
 * @method CtrSlnFormal      setIdSlnFormal()                 Sets the current record's "id_sln_formal" value
 * @method CtrSlnFormal      setDatRdeInscripcion()           Sets the current record's "DatRdeInscripcion" value
 * @method CtrSlnFormal      setDatRdeInscripcion2()          Sets the current record's "DatRdeInscripcion_2" value
 * @method CtrSlnFormal      setDatSlnCursoOferta()           Sets the current record's "DatSlnCursoOferta" value
 * @method CtrSlnFormal      setDatSlnCursoOferta4()          Sets the current record's "DatSlnCursoOferta_4" value
 * @method CtrSlnFormal      setDatSlnCursoOferta5()          Sets the current record's "DatSlnCursoOferta_5" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseCtrSlnFormal extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ctr_sln_formal');
