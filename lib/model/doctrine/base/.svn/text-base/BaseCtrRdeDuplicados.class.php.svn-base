...
Doctrine_Manager::getInstance()->bindComponent('CtrRdeDuplicados', 'doctrine');

/**
 * BaseCtrRdeDuplicados
 * 
 ...
 * @method CtrRdeDuplicados  setInscripcionId()       Sets the current record's "inscripcion_id" value
 * @method CtrRdeDuplicados  setGestionId()           Sets the current record's "gestion_id" value
 * @method CtrRdeDuplicados  setCodUeId()             Sets the current record's "cod_ue_id" value
 * @method CtrRdeDuplicados  setCodigoRudeId()        Sets the current record's "codigo_rude_id" value
 * @method CtrRdeDuplicados  setDatRdeEstudiante()    Sets the current record's "DatRdeEstudiante" value
 * @method CtrRdeDuplicados  setDatRdeInscripcion()   Sets the current record's "DatRdeInscripcion" value
 * @method CtrRdeDuplicados  setDatRdeInscripcion3()  Sets the current record's "DatRdeInscripcion_3" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseCtrRdeDuplicados extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ctr_rde_duplicados');
