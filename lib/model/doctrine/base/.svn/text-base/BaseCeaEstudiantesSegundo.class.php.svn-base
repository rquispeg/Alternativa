...
Doctrine_Manager::getInstance()->bindComponent('CeaEstudiantesSegundo', 'doctrine');

/**
 * BaseCeaEstudiantesSegundo
 * 
 ...
 * @method CeaEstudiantesSegundo setId()                Sets the current record's "id" value
 * @method CeaEstudiantesSegundo setDescDepartamento()  Sets the current record's "desc_departamento" value
 * @method CeaEstudiantesSegundo setCodDistrito()       Sets the current record's "cod_distrito" value
 * @method CeaEstudiantesSegundo setGestionId()         Sets the current record's "gestion_id" value
 * @method CeaEstudiantesSegundo setDistrito()          Sets the current record's "distrito" value
 * @method CeaEstudiantesSegundo setCodUe()             Sets the current record's "cod_ue" value
 * @method CeaEstudiantesSegundo setDescUe()            Sets the current record's "desc_ue" value
 * @method CeaEstudiantesSegundo setPeriodoId()         Sets the current record's "periodo_id" value
 * @method CeaEstudiantesSegundo setDescNivel()         Sets the current record's "desc_nivel" value
 * @method CeaEstudiantesSegundo setDescCiclo()         Sets the current record's "desc_ciclo" value
 * @method CeaEstudiantesSegundo setDescGrado()         Sets the current record's "desc_grado" value
 * @method CeaEstudiantesSegundo setCodigoRude()        Sets the current record's "codigo_rude" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseCeaEstudiantesSegundo extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('cea_estudiantes_segundo');
