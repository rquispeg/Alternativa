...
Doctrine_Manager::getInstance()->bindComponent('SdatRdeInscripcionTmp', 'doctrine');

/**
 * BaseSdatRdeInscripcionTmp
 * 
 ...
 * @method SdatRdeInscripcionTmp setInscripcionId()              Sets the current record's "inscripcion_id" value
 * @method SdatRdeInscripcionTmp setGestionId()                  Sets the current record's "gestion_id" value
 * @method SdatRdeInscripcionTmp setCodigoRudeId()               Sets the current record's "codigo_rude_id" value
 * @method SdatRdeInscripcionTmp setNumMatricula()               Sets the current record's "num_matricula" value
 * @method SdatRdeInscripcionTmp setCodUeId()                    Sets the current record's "cod_ue_id" value
 * @method SdatRdeInscripcionTmp setPeriodoId()                  Sets the current record's "periodo_id" value
 * @method SdatRdeInscripcionTmp setSubCeaId()                   Sets the current record's "sub_cea_id" value
 * @method SdatRdeInscripcionTmp setGradoId()                    Sets the current record's "grado_id" value
 * @method SdatRdeInscripcionTmp setCicloId()                    Sets the current record's "ciclo_id" value
 * @method SdatRdeInscripcionTmp setNivelId()                    Sets the current record's "nivel_id" value
 * @method SdatRdeInscripcionTmp setParalelo()                   Sets the current record's "paralelo" value
 * @method SdatRdeInscripcionTmp setTurnoId()                    Sets the current record's "turno_id" value
 * @method SdatRdeInscripcionTmp setEstadoMatriculaInicioId()    Sets the current record's "estado_matricula_inicio_id" value
 * @method SdatRdeInscripcionTmp setEstadoMatriculaFinId()       Sets the current record's "estado_matricula_fin_id" value
 * @method SdatRdeInscripcionTmp setCodUeProcedenciaId()         Sets the current record's "cod_ue_procedencia_id" value
 * @method SdatRdeInscripcionTmp setObservacionId()              Sets the current record's "observacion_id" value
 * @method SdatRdeInscripcionTmp setObservacion()                Sets the current record's "observacion" value
 * @method SdatRdeInscripcionTmp setFechaInscripcion()           Sets the current record's "fecha_inscripcion" value
 * @method SdatRdeInscripcionTmp setApreciacionFinal()           Sets the current record's "apreciacion_final" value
 * @method SdatRdeInscripcionTmp setDatRdeEstudiante()           Sets the current record's "DatRdeEstudiante" value
 * @method SdatRdeInscripcionTmp setClaEstadoMatricula()         Sets the current record's "ClaEstadoMatricula" value
 * @method SdatRdeInscripcionTmp setClaEstadoMatricula3()        Sets the current record's "ClaEstadoMatricula_3" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso()               Sets the current record's "SdatSieCurso" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso5()              Sets the current record's "SdatSieCurso_5" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso6()              Sets the current record's "SdatSieCurso_6" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso7()              Sets the current record's "SdatSieCurso_7" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso8()              Sets the current record's "SdatSieCurso_8" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso9()              Sets the current record's "SdatSieCurso_9" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso10()             Sets the current record's "SdatSieCurso_10" value
 * @method SdatRdeInscripcionTmp setSdatSieCurso11()             Sets the current record's "SdatSieCurso_11" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseSdatRdeInscripcionTmp extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('sdat_rde_inscripcion_tmp');
