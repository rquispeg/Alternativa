...
Doctrine_Manager::getInstance()->bindComponent('TmpDiplomasImpresos2011', 'doctrine');

/**
 * BaseTmpDiplomasImpresos2011
 * 
 ...
 * @method TmpDiplomasImpresos2011 setId()                 Sets the current record's "id" value
 * @method TmpDiplomasImpresos2011 setGestionId()          Sets the current record's "gestion_id" value
 * @method TmpDiplomasImpresos2011 setDescDepartamento()   Sets the current record's "desc_departamento" value
 * @method TmpDiplomasImpresos2011 setCodDistrito()        Sets the current record's "cod_distrito" value
 * @method TmpDiplomasImpresos2011 setDistrito()           Sets the current record's "distrito" value
 * @method TmpDiplomasImpresos2011 setCodUe()              Sets the current record's "cod_ue" value
 * @method TmpDiplomasImpresos2011 setDescUe()             Sets the current record's "desc_ue" value
 * @method TmpDiplomasImpresos2011 setCalculatedColumn1()  Sets the current record's "calculated_column1" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseTmpDiplomasImpresos2011 extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('tmp_diplomas_impresos_2011');
