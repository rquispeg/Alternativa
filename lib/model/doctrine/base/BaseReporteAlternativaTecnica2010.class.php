...
Doctrine_Manager::getInstance()->bindComponent('ReporteAlternativaTecnica2010', 'doctrine');

/**
 * BaseReporteAlternativaTecnica2010
 * 
 ...
 * @method ReporteAlternativaTecnica2010 setId()                 Sets the current record's "id" value
 * @method ReporteAlternativaTecnica2010 setGestionId()          Sets the current record's "gestion_id" value
 * @method ReporteAlternativaTecnica2010 setPeriodo()            Sets the current record's "periodo" value
 * @method ReporteAlternativaTecnica2010 setDescDepartamento()   Sets the current record's "desc_departamento" value
 * @method ReporteAlternativaTecnica2010 setCodDistrito()        Sets the current record's "cod_distrito" value
 * @method ReporteAlternativaTecnica2010 setDistrito()           Sets the current record's "distrito" value
 * @method ReporteAlternativaTecnica2010 setIdNivel()            Sets the current record's "id_nivel" value
 * @method ReporteAlternativaTecnica2010 setCodUe()              Sets the current record's "cod_ue" value
 * @method ReporteAlternativaTecnica2010 setDescUe()             Sets the current record's "desc_ue" value
 * @method ReporteAlternativaTecnica2010 setDescNivel()          Sets the current record's "desc_nivel" value
 * @method ReporteAlternativaTecnica2010 setIdCiclo()            Sets the current record's "id_ciclo" value
 * @method ReporteAlternativaTecnica2010 setDescCiclo()          Sets the current record's "desc_ciclo" value
 * @method ReporteAlternativaTecnica2010 setIdGrado()            Sets the current record's "id_grado" value
 * @method ReporteAlternativaTecnica2010 setDescGrado()          Sets the current record's "desc_grado" value
 * @method ReporteAlternativaTecnica2010 setGenero()             Sets the current record's "genero" value
 * @method ReporteAlternativaTecnica2010 setCalculatedColumn1()  Sets the current record's "calculated_column1" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseReporteAlternativaTecnica2010 extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('reporte_alternativa_tecnica_2010');
