...
Doctrine_Manager::getInstance()->bindComponent('CtrRdeFechaNacimiento', 'doctrine');

/**
 * BaseCtrRdeFechaNacimiento
 * 
 ...
 * @method CtrRdeFechaNacimiento setInscripcionId()       Sets the current record's "inscripcion_id" value
 * @method CtrRdeFechaNacimiento setGestionId()           Sets the current record's "gestion_id" value
 * @method CtrRdeFechaNacimiento setCodUeId()             Sets the current record's "cod_ue_id" value
 * @method CtrRdeFechaNacimiento setCodigoRudeId()        Sets the current record's "codigo_rude_id" value
 * @method CtrRdeFechaNacimiento setDatRdeInscripcion()   Sets the current record's "DatRdeInscripcion" value
 * @method CtrRdeFechaNacimiento setDatRdeInscripcion2()  Sets the current record's "DatRdeInscripcion_2" value
 * @method CtrRdeFechaNacimiento setDatRdeEstudiante()    Sets the current record's "DatRdeEstudiante" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseCtrRdeFechaNacimiento extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('ctr_rde_fecha_nacimiento');
