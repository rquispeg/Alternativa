...
Doctrine_Manager::getInstance()->bindComponent('VInscripcion2007', 'doctrine');

/**
 * BaseVInscripcion2007
 * 
 ...
 * @method VInscripcion2007 setId()                         Sets the current record's "id" value
 * @method VInscripcion2007 setIdInscripcion()              Sets the current record's "id_inscripcion" value
 * @method VInscripcion2007 setGestionId()                  Sets the current record's "gestion_id" value
 * @method VInscripcion2007 setCodigoRudeId()               Sets the current record's "codigo_rude_id" value
 * @method VInscripcion2007 setNumMatricula()               Sets the current record's "num_matricula" value
 * @method VInscripcion2007 setCodUeId()                    Sets the current record's "cod_ue_id" value
 * @method VInscripcion2007 setPeriodoId()                  Sets the current record's "periodo_id" value
 * @method VInscripcion2007 setOperativoId()                Sets the current record's "operativo_id" value
 * @method VInscripcion2007 setSubCeaId()                   Sets the current record's "sub_cea_id" value
 * @method VInscripcion2007 setNivelId()                    Sets the current record's "nivel_id" value
 * @method VInscripcion2007 setGradoId()                    Sets the current record's "grado_id" value
 * @method VInscripcion2007 setCicloId()                    Sets the current record's "ciclo_id" value
 * @method VInscripcion2007 setParalelo()                   Sets the current record's "paralelo" value
 * @method VInscripcion2007 setTurnoId()                    Sets the current record's "turno_id" value
 * @method VInscripcion2007 setEstadoMatriculaInicioId()    Sets the current record's "estado_matricula_inicio_id" value
 * @method VInscripcion2007 setEstadoMatriculaFinId()       Sets the current record's "estado_matricula_fin_id" value
 * @method VInscripcion2007 setCodUeProcedenciaId()         Sets the current record's "cod_ue_procedencia_id" value
 * @method VInscripcion2007 setObservacionId()              Sets the current record's "observacion_id" value
 * @method VInscripcion2007 setObservacion()                Sets the current record's "observacion" value
 * @method VInscripcion2007 setFechaInscripcion()           Sets the current record's "fecha_inscripcion" value
 * @method VInscripcion2007 setApreciacionFinal()           Sets the current record's "apreciacion_final" value
 * 
 * @package    alternativa
 * @subpackage model
 ...
 */
abstract class BaseVInscripcion2007 extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('v_inscripcion_2007');
