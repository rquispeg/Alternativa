...
/**
 * CtrRdeExtemporaneoEspecial filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseCtrRdeExtemporaneoEspecialFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'inscripcion_id'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('DatRdeInscripcionEspecial'), 'add_empty' => true)),
      'gestion_id'         => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('DatRdeInscripcionEspecial_2'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'inscripcion_id'     => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('DatRdeInscripcionEspecial'), 'column' => 'id_inscripcion')),
      'gestion_id'         => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('DatRdeInscripcionEspecial_2'), 'column' => 'id_inscripcion')),
    ...
    $this->widgetSchema->setNameFormat('ctr_rde_extemporaneo_especial_filters[%s]');
