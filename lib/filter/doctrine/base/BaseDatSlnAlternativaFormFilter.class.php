...
/**
 * DatSlnAlternativa filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseDatSlnAlternativaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_sln_alternativa_filters[%s]');
