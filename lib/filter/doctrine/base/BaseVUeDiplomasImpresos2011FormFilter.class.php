...
/**
 * VUeDiplomasImpresos2011 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseVUeDiplomasImpresos2011FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_ue_diplomas_impresos2011_filters[%s]');
