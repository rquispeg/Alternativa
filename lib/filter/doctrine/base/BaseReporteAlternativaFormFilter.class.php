...
/**
 * ReporteAlternativa filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseReporteAlternativaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reporte_alternativa_filters[%s]');
