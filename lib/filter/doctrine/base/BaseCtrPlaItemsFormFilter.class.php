...
/**
 * CtrPlaItems filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseCtrPlaItemsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_pla_items_filters[%s]');
