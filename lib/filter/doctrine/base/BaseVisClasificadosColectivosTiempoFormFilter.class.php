...
/**
 * VisClasificadosColectivosTiempo filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
...
abstract class BaseVisClasificadosColectivosTiempoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'tiempo'             => new sfValidatorSchemaFilter('text', new sfValidatorNumber(array('required' => false))),
    ));

    $this->widgetSchema->setNameFormat('vis_clasificados_colectivos_tiempo_filters[%s]');
