...
/**
 * VEstadisticaAlternativa filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseVEstadisticaAlternativaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_estadistica_alternativa_filters[%s]');
