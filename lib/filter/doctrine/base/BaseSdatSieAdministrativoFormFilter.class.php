...
/**
 * SdatSieAdministrativo filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseSdatSieAdministrativoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sdat_sie_administrativo_filters[%s]');
