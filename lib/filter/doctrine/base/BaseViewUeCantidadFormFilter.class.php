...
/**
 * ViewUeCantidad filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseViewUeCantidadFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('view_ue_cantidad_filters[%s]');
