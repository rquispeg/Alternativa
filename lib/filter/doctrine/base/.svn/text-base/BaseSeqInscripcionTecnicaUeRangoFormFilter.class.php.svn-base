...
/**
 * SeqInscripcionTecnicaUeRango filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseSeqInscripcionTecnicaUeRangoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('seq_inscripcion_tecnica_ue_rango_filters[%s]');
