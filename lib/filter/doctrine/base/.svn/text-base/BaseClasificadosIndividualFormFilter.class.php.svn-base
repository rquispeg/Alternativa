...
/**
 * ClasificadosIndividual filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseClasificadosIndividualFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('clasificados_individual_filters[%s]');
