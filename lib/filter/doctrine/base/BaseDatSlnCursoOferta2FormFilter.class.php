...
/**
 * DatSlnCursoOferta2 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseDatSlnCursoOferta2FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_sln_curso_oferta2_filters[%s]');
