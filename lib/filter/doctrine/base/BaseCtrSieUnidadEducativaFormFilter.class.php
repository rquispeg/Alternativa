...
/**
 * CtrSieUnidadEducativa filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseCtrSieUnidadEducativaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_sie_unidad_educativa_filters[%s]');
