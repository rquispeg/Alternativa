...
/**
 * DatRdeDatosapoderado filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseDatRdeDatosapoderadoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_rde_datosapoderado_filters[%s]');
