...
/**
 * DatEdaMatricula filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseDatEdaMatriculaFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dat_eda_matricula_filters[%s]');
