...
abstract class BaseClaTraProcesoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'interaccion_sistema' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ));
    ...
    $this->setValidators(array(
      ...
      'interaccion_sistema' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ));
