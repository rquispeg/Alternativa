...
/**
 * VUeBachilleres2011 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseVUeBachilleres2011FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_ue_bachilleres2011_filters[%s]');
