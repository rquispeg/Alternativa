...
/**
 * SdatRdeInscripcion filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseSdatRdeInscripcionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sdat_rde_inscripcion_filters[%s]');
