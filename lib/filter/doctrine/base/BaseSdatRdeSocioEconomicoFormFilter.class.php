...
/**
 * SdatRdeSocioEconomico filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseSdatRdeSocioEconomicoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sdat_rde_socio_economico_filters[%s]');
