...
/**
 * CeaEstudiantesSegundo filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseCeaEstudiantesSegundoFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('cea_estudiantes_segundo_filters[%s]');
