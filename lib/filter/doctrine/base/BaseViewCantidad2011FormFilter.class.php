...
/**
 * ViewCantidad2011 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseViewCantidad2011FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('view_cantidad2011_filters[%s]');
