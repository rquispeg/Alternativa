...
/**
 * SdatSieDocente filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseSdatSieDocenteFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sdat_sie_docente_filters[%s]');
