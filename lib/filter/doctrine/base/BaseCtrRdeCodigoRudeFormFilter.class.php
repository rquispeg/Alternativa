...
/**
 * CtrRdeCodigoRude filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseCtrRdeCodigoRudeFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_rde_codigo_rude_filters[%s]');
