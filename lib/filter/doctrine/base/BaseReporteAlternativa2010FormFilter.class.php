...
/**
 * ReporteAlternativa2010 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseReporteAlternativa2010FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reporte_alternativa2010_filters[%s]');
