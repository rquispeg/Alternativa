...
/**
 * TmpDiplomasImpresos filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseTmpDiplomasImpresosFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tmp_diplomas_impresos_filters[%s]');
