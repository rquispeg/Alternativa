...
/**
 * CtrSlnFormal2 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseCtrSlnFormal2FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ctr_sln_formal2_filters[%s]');
