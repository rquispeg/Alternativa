...
/**
 * TmpDiplomasImpresos2011 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseTmpDiplomasImpresos2011FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tmp_diplomas_impresos2011_filters[%s]');
