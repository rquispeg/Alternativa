...
/**
 * AuxDplLegalizacion filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseAuxDplLegalizacionFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('aux_dpl_legalizacion_filters[%s]');
