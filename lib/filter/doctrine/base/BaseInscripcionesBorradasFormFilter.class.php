...
/**
 * InscripcionesBorradas filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseInscripcionesBorradasFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('inscripciones_borradas_filters[%s]');
