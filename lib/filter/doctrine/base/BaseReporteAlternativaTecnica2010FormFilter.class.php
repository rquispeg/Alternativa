...
/**
 * ReporteAlternativaTecnica2010 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseReporteAlternativaTecnica2010FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('reporte_alternativa_tecnica2010_filters[%s]');
