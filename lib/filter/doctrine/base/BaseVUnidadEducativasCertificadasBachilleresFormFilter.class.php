...
/**
 * VUnidadEducativasCertificadasBachilleres filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseVUnidadEducativasCertificadasBachilleresFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_unidad_educativas_certificadas_bachilleres_filters[%s]');
