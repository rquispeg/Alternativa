...
/**
 * VCeaDiplomasImpresos2011 filter form base class.
 *
 * @package    alternativa
 * @subpackage filter
 ...
 */
abstract class BaseVCeaDiplomasImpresos2011FormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('v_cea_diplomas_impresos2011_filters[%s]');
