...
<table width="100%" class="tabla" cellpadding="0" cellspacing="5">
    ...
    <tr>        
        <td class="dato">            
            <input readonly="readonly" type="text" name="datos[subcea]" size="2" value="<?php echo $parametros['subcea']; ?>"></input>
        </td>
        <td colspan="4" class="dato">
            <input type="text" name="datos[nombre_subcea]" size="50" ></input>
        </td>
    </tr>    
    <tr>
    ...
    <tr>
        <td colspan="2" class="dato">
            <input type="text" name="datos[director]" size="50"></input>
            <?php //echo $director->getDirector(); ?>
        </td>
        <td colspan="2" class="dato">
            <input type="text" name="datos[cidirector]" size="10" onkeydown="return validarNumero(event);"></input>
