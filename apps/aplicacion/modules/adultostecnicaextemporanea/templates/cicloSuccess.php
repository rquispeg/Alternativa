...
<select id="grado_id" style="font-family: Arial;font-size: 12px;width: 180px;" name="dat_rde_estudiante[grado_id]">
...
<?php echo jquery_ajax(array(
    'listener' => array(
        'selector' => '#grado_id',
        'event' => 'change'),
    'url' => url_for('adultostecnicaextemporanea/especialidad'),
