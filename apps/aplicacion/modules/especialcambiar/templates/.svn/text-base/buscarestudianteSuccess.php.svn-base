...
<?php else: ?>
        ...
        <br />
        <?php include_partial('especialcambiar/datosinscripcion', array('inscripcion' => $inscripcion)); ?>
        <br />
        <?php include_partial('especialcambiar/datosunidadeducativa', array('niveles' => $niveles)); ?>
        <br />
<?php endif; ?>
