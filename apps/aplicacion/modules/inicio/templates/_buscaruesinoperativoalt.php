        ...
        <table align="center">
            ...
            <tr>
                ...
                <td>
                    ...
                    SUB CEA: <input type="text" id="dat_sie_operativos_subcea" name="dat_sie_operativos[subcea]" size="2" maxlength="2" value="0" onkeydown="return validarNumero(event);" />
                    GESTION: <?php echo $operativo['gestion_id']->render() ?>
                    PERIODO: <?php echo $operativo['periodo_id']->render() ?>
