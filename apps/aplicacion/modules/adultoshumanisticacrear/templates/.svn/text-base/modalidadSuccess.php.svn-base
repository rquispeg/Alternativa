...
<select id="modalidad_id" style="font-family: Arial;font-size: 12px;width:300px;" name="form[modalidad_id]">
    <option value="-999">[Seleccionar]</option>
    <?php foreach($modalidades as $modalidad): ?>
        <option value="<?php echo $modalidad->getIdNivel(); ?>"><?php echo $modalidad->getIdNivel().' - '.$modalidad->getDescNivel(); ?></option>
    <?php endforeach; ?>
</select>
...
<?php echo jquery_ajax(array(
            'listener' => array(
                ...
                'event' => 'change'),
            'url' => url_for('adultoshumanisticacrear/nivel'),
