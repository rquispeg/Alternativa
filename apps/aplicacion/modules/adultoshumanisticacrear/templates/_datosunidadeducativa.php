...
DATOS DEL CENTRO DE EDUCACI&Oacute;N ALTERNATIVA
    ...
    <table align="center" style="width:100%;padding: 10px 10px 0px 10px;">
        ...
        <tr>
            ...
            <td><?php include_partial('adultoshumanisticacrear/combounidadeducativa',array('unidades'=>$unidades)); ?></td>
    ...
    <table align="center" style="width:100%;padding: 10px;">
        ...
        <tr>
            <td><div id="ciclo"><select id="ciclo_id" style="font-family: Arial;font-size: 12px;width: 350px;"><option value="-999">[Seleccionar]</option></select></div></td>
...
function enviar()
{
  if(($('#unidad_educativa').val() == -999)||($('#subcea_id').val() == -999)||($('#modalidad_id').val() == -999)||($('#nivel_id').val() == -999)||($('#ciclo_id').val() == -999)||($('#paralelo_id').val() == -999)||($('#turno_id').val() == -999)){
    ...
    window.location = '<?php echo url_for('adultoshumanisticacrear/guardarcurso'); ?>'+'?ue_id='+$('#unidad_educativa').val()+'&subcea_id='+$('#subcea_id').val()+'&periodo_id='+$('#periodo_id').val()+'&modalidad_id='+$('#modalidad_id').val()+'&nivel_id='+$('#nivel_id').val()+'&grado_id='+$('#grado_id').val()+'&paralelo_id='+$('#paralelo_id').val()+'&turno_id='+$('#turno_id').val();
  }
}
/* ]]> */
</script>
