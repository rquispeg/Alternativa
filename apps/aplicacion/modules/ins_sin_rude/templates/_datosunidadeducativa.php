...
DATOS DEL CENTRO DE EDUCACI&Oacute;N ALTERNATIVA
    ...
    <table align="center" style="width:740px;">
        ...
        <tr><td><select name="dat_rde_estudiante[periodo_id]" id="periodo_id" style="font-family: Arial;font-size: 12px;width:100px;"><option value="-999">[Seleccionar]</option>
                    ...
                    <?php echo jquery_ajax(array(
                                'listener' => array(
                                    'selector' => '#periodo_id',
                                    'event' => 'change'),
                                'url' => url_for('adultoshumanisticaextemporaneosinrude/periodo'),
            ...
            <td><div id="subcentro"><select id="subcea_id" style="font-family: Arial;font-size: 12px;width:200px;"><option value="-999">[Seleccionar]</option></select></div></td>
        </tr>
    </table>
    <table align="center" style="width:740px;">
        <tr>
