...
<form method="POST" action="<?php echo url_for('adultostecnicainscripcionsinrude/inscribirestudiante'); ?>" >
...
<?php endif; ?>
<?php include_partial('adultostecnicainscripcionsinrude/datosunidadeducativa'); ?>
