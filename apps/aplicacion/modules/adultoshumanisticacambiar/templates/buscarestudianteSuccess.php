...
<?php else: ?>
        ...
        <br />
        <?php include_partial('adultoshumanisticacambiar/datosinscripcion', array('inscripcion' => $inscripcion)); ?>
        <br />
        <?php include_partial('adultoshumanisticacambiar/datosunidadeducativa', array('modalidades' => $modalidades)); ?>
        <br />
<?php endif; ?>
