...
<?php echo jquery_ajax(array(
            'listener' => array(
                ...
                'event' => 'change'),
            'url' => url_for('adultoshumanisticainscripcion/turno'),
            'success' =>  like_function("$('#turno').html(data)" , 'data'),
            'data' => "'paralelo_id='+". jquery_get('this','val')."+'&ue_id='+document.getElementById('unidad_educativa').value+'&modalidad_id='+document.getElementById('modalidad_id').value+'&nivel_id='+document.getElementById('nivel_id').value+'&ciclo_id='+document.getElementById('ciclo_id').value+'&subcea_id='+document.getElementById('subcea_id').value",
            'type' => 'POST'));
?>
