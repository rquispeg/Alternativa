...
<?php echo jquery_ajax(array(
            'listener' => array(
                ...
                'event' => 'change'),
            'url' => url_for('adultoshumanisticainscripcionanterior/subcentro'),
            'success' =>  like_function("$('#subcentro').html(data)" , 'data'),
            'data' => "'ue_id=' + ". jquery_get('this','val')."+'&periodo_id='+document.getElementById('periodo_id').value+'&gestion_id='+document.getElementById('gestion_id').value",
            'type' => 'POST'));
?>
