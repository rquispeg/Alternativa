...
<div id="divResults" style="width:770px;margin-left: auto; margin-right: auto;">
    <form id="myForm" action="#">
        <?php include_partial('adultoshumanisticainscripcionanterior/formularioestudiante',array('estudiante'=>$estudiante)); ?>
...
echo jquery_ajax_form(
      '#myForm',
      array(
        'url' => url_for('adultoshumanisticainscripcionanterior/unidadeducativa'),
