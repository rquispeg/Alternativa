...
DATOS DEL CENTRO DE EDUCACI&Oacute;N ALTERNATIVA
    ...
    <table align="center" style="width:740px;">
        <tr>
            <td class="caption">A&ntilde;o</td>
        ...
        <tr><td>
                <select name="dat_rde_estudiante[gestion_id]" id="gestion_id" style="font-family: Arial;font-size: 12px;width:80px;">
                    <option value="-999">[Seleccionar]</option>
                    <option value="2010">2010</option>                    
                </select>
            </td>
            <td><select name="dat_rde_estudiante[periodo_id]" id="periodo_id" style="font-family: Arial;font-size: 12px;width:100px;">
                    <option value="-999">[Seleccionar]</option>
                    ...
                    <?php echo jquery_ajax(array(
                                'listener' => array(
                                    'selector' => '#periodo_id',
                                    'event' => 'change'),
                                'url' => url_for('adultoshumanisticainscripcionanterior/periodo'),
                                'success' =>  like_function("$('#unidad').html(data)" , 'data'),
                                'data' => "'periodo_id=' + ". jquery_get('this','val')."+'&gestion_id='+document.getElementById('gestion_id').value",
                                'type' => 'POST'));
                    ?>
                    <?php
            ...
            <td><div id="subcentro"><select id="subcea_id" style="font-family: Arial;font-size: 12px;width:80px;">
                        <option value="-999">[Seleccionar]</option></select></div></td>
        </tr>
    </table>
    <table align="center" style="width:740px;">
        <tr>
