...
<form method="POST" action="<?php echo url_for('adultoshumanisticaextemporaneosinrude/inscribirestudiante'); ?>" >
...
<?php endif; ?>
<?php include_partial('adultoshumanisticaextemporaneosinrude/datosunidadeducativa'); ?>
