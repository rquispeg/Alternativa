...
<form method="POST" action="<?php echo url_for('especialinscripcionsinrude/inscribirestudiante'); ?>" >
<?php if($estudiantes->Count()>0): ?>
<?php include_partial('adultoshumanisticaextemporaneosinrude/datosestudiantes',array('estudiantes'=>$estudiantes)); ?>
<?php endif; ?>
<?php include_partial('especialinscripcionsinrude/datosunidadeducativa',array('unidades'=>$unidades)); ?>
