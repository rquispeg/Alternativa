...
abstract class autoUsuarioActions extends sfActions
{
  ...
  public function executeNew(sfWebRequest $request)
  {
    ...
    $this->dat_usu_usuario = $this->form->getObject();
  }
  ...
  {
    $this->dat_usu_usuario = $this->getRoute()->getObject();
    $this->form = $this->configuration->getForm($this->dat_usu_usuario);
  }
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorDoctrineChoice(array('multiple' => true, 'model' => 'DatUsuUsuario'));
    try
    {
      // validate ids
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      if ($request->hasParameter('_save_and_add'))
      {
        ...
        $this->redirect('@dat_usu_usuario_new');
      }
      else
      {
        $this->getUser()->setFlash('notice', $notice);

        $this->redirect(array('sf_route' => 'dat_usu_usuario_edit', 'sf_subject' => $dat_usu_usuario));
      }
    }
    else
    {
  ...
  {
    $pager = $this->configuration->getPager('DatUsuUsuario');
  ...
  {
    return Doctrine::getTable('DatUsuUsuario')->hasColumn($column);
  }
}
